...
NDiplomacy = {
	...
	DISHONORABLE_PEACE_MONTHS = 1,					-- See DISHONORABLE_PEACE_WARSCORE. Set to 0 to entirely disable the feature.11
...
NCountry = {
	...
	DEVELOPMENT_ON_CONTINENT_FOR_NEW_CAPITAL = 0,	-- How many percent of your development needs to be on the other continent to move your capital there
	...
	STRENGTHEN_GOVERNMENT_REPUBLICAN_TRADITION = 13,
...
NMilitary = {
	...
	TRADITION_GAIN_LAND = 23,						-- Tradition gain base value from land combat.
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.7,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
